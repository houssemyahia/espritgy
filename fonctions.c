...
FILE* f;
char ch[30],ch1[30];
f=fopen("/home/houssem/Desktop/projectf1/src/users","r");
if(f!=NULL)
{
...
f=fopen("/home/houssem/Desktop/projectf1/src/myspace.txt","w");
...
f=fopen("/home/houssem/Desktop/projectf1/src/myspace.txt","r");
...
f=fopen("/home/houssem/Desktop/projectf1/src/horaire.txt","r");
...
f=fopen("/home/houssem/Desktop/projectf1/src/RDV_KINE.txt","r");
...
f5=fopen("/home/houssem/Desktop/projectf1/src/RDV_KINE.txt","r");
if(f5!=NULL)
{
...
int v=0; // salle non reserve
FILE *f6;
f6=fopen("/home/houssem/Desktop/projectf1/src/horaire.txt","r");
if(f6!=NULL)
{
while(fscanf(f6,"%d %d %d %s ",&s.jour,&s.mois,&s.annee,s.temps)!=EOF)
{if (s.jour==sa.jour) {
if (s.mois==sa.mois) {
if (s.annee==sa.annee) {
if (strcmp(s.temps,sa.temps)==0)
{v=1;}
}
}
}
